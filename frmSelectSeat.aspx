<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="frmSelectSeat.aspx.cs" Inherits="frmSelectSeat" Title="Untitled Page" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                ...
                <td style="width:50%" valign="top">
                    <table>
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlBoardingPoint" runat="server" Width="150px" 
                                    onselectedindexchanged="ddlBoardingPoint_SelectedIndexChanged"></asp:DropDownList>
        ...
        <table width="100%">
            ...
            <tr>
                <td align="center" style="color:Gray;">
                    ...
                    &nbsp; Booked Man:<asp:Image ID="Image3" runat="server" ImageUrl="~/Images/Booked.gif" />
                    &nbsp; Booked Woman:<asp:Image ID="Image4" runat="server" ImageUrl="~/Images/Female.gif" />
                    &nbsp; Pilot:<asp:Image ID="Image5" runat="server" ImageUrl="~/Images/Driver.gif" />
                </td>
            </tr>
            <tr>
                <td style="height:30px;"></td>
							...
							<Columns>
								...
								<asp:TemplateColumn HeaderText="First Name">
									...
									<ItemTemplate>
                                        ...
                                        <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender10" runat="server" TargetControlID="txtFirstName" FilterType="LowercaseLetters">
                                        </cc1:FilteredTextBoxExtender>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtFirstName"
                                          ErrorMessage="*" Width="178px"></asp:RequiredFieldValidator>
									</ItemTemplate>
								</asp:TemplateColumn>
								<asp:TemplateColumn HeaderText="Last Name">
									...
									<ItemTemplate>
                                        ...
                                        <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender11" runat="server" TargetControlID="txtLastName" FilterType="LowercaseLetters">
                                        </cc1:FilteredTextBoxExtender>
        ...
        <table width="100%" style="border-bottom-width:thin; border-bottom-color:Silver; border-bottom-style:solid;">
         ...
         <table width="100%">
                    ...
                    Width="184px"></asp:RegularExpressionValidator>
                        </td>
                        <td style="width:20%" align="right">
                            Address:
                        </td>
                    ...
                    <tr class="trdata2">
                        ...
                        <td style="width:30%">
                            ...
                            <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender3" runat="server" TargetControlID="txtMobileNo" FilterType="Numbers">
                                        </cc1:FilteredTextBoxExtender>
