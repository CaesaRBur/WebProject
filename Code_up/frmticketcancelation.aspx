<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="frmticketcancelation.aspx.cs" Inherits="frmticketcancelation" Title="Untitled Page" %>
...
<center>
            ...
            <tr>
                ...
                <td width="50%" align="left">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                        ErrorMessage="* Enter PNR No" ControlToValidate="txtPnrno" 
                ...
                <td width="50%" align="right">
                    ...
                    <asp:TextBox ID="txtFirstname" runat="server"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                            ...
                            ErrorMessage="* Enter First Name" ValidationGroup="Search"></asp:RequiredFieldValidator>
                    </td>
            </tr>
            <tr>
                <td width="50%" align="right">
                    ...
                    <asp:TextBox ID="txtLastname" runat="server"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                            ...
                            ErrorMessage="* Enter Last Name" ValidationGroup="Search"></asp:RequiredFieldValidator>
                    </td>
            </tr>
                <tr>
                    <td width="50%" align="right">
                        <asp:Label ID="Label4" runat="server" CssClass="FontBold" Text="Date Of Journey:"></asp:Label>
                        &nbsp;</td>
                    <td width="50%" align="left">
                    ...
                    <asp:ImageButton ID="imgbtnJourneydate" runat="server" ImageUrl="~/Images/cal.gif" />
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                            ControlToValidate="txtDOJ" Display="Dynamic" ErrorMessage="* Enter Date" 
    ...
    <center>
        <table width="40%">
            ...
            <tr>
                <td>
                    <asp:Button ID="btnCancelyourticket" runat="server" Text="Cancel Your Ticket" onclick="btnCancelyourticket_Click"  Visible="false"
                        />
                </td>
            </tr>
            <tr>
                <td>
                    <asp:Label ID="lblTicket" runat="server" ForeColor="Red"></asp:Label>
                </td>
            </tr>
    </table>
    </asp:Panel>
